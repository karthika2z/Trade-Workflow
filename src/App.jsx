...
import {
  Workflow, Settings, Play, Plus, ChevronRight,
  Clock, Zap, BarChart3, Bot, Webhook, Menu, X, Sparkles
} from 'lucide-react';
...
function App() {
  const [view, setView] = useState('workflows'); // workflows, editor, execution, settings, community
  ...
  const handleImportFromCommunity = (workflow) => {
    setView('workflows');
  };
              ...
              <div className="p-6 border-b border-terminal-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Intelligent Trading</p>
                  </div>
                </div>
              </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {view === 'community' && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -20 }}
                >
                  <CommunityBrowser onImport={handleImportFromCommunity} />
                </motion.div>
              )}
            </AnimatePresence>
          </div>
